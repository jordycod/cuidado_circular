...
--
-- Host: 127.0.0.1
-- Tempo de geração: 03/12/2023 às 16:18
...
--
-- Estrutura para tabela `cond_instances`
--
...
--
-- Estrutura para tabela `events_stages_current`
--
...
--
-- Estrutura para tabela `events_stages_history`
--
...
--
-- Estrutura para tabela `events_stages_history_long`
--
...
--
-- Estrutura para tabela `events_stages_summary_by_account_by_event_name`
--
...
--
-- Estrutura para tabela `events_stages_summary_by_host_by_event_name`
--
...
--
-- Estrutura para tabela `events_stages_summary_by_thread_by_event_name`
--
...
--
-- Estrutura para tabela `events_stages_summary_by_user_by_event_name`
--
...
--
-- Estrutura para tabela `events_stages_summary_global_by_event_name`
--
...
--
-- Estrutura para tabela `events_statements_current`
--
...
--
-- Estrutura para tabela `events_statements_history`
--
...
--
-- Estrutura para tabela `events_statements_history_long`
--
...
--
-- Estrutura para tabela `events_statements_summary_by_account_by_event_name`
--
...
--
-- Estrutura para tabela `events_statements_summary_by_digest`
--
...
--
-- Estrutura para tabela `events_statements_summary_by_host_by_event_name`
--
...
--
-- Estrutura para tabela `events_statements_summary_by_thread_by_event_name`
--
...
--
-- Estrutura para tabela `events_statements_summary_by_user_by_event_name`
--
...
--
-- Estrutura para tabela `events_statements_summary_global_by_event_name`
--
...
--
-- Estrutura para tabela `events_waits_current`
--
...
--
-- Estrutura para tabela `events_waits_history`
--
...
--
-- Estrutura para tabela `events_waits_history_long`
--
...
--
-- Estrutura para tabela `events_waits_summary_by_account_by_event_name`
--
...
--
-- Estrutura para tabela `events_waits_summary_by_host_by_event_name`
--
...
--
-- Estrutura para tabela `events_waits_summary_by_instance`
--
...
--
-- Estrutura para tabela `events_waits_summary_by_thread_by_event_name`
--
...
--
-- Estrutura para tabela `events_waits_summary_by_user_by_event_name`
--
...
--
-- Estrutura para tabela `events_waits_summary_global_by_event_name`
--
...
--
-- Estrutura para tabela `file_instances`
--
...
--
-- Estrutura para tabela `file_summary_by_event_name`
--
...
--
-- Estrutura para tabela `file_summary_by_instance`
--
...
--
-- Estrutura para tabela `host_cache`
--
...
--
-- Estrutura para tabela `mutex_instances`
--
...
--
-- Estrutura para tabela `objects_summary_global_by_type`
--
...
--
-- Estrutura para tabela `performance_timers`
--
...
--
-- Estrutura para tabela `rwlock_instances`
--
...
--
-- Estrutura para tabela `session_account_connect_attrs`
--
...
--
-- Estrutura para tabela `session_connect_attrs`
--
...
--
-- Estrutura para tabela `setup_actors`
--
...
--
-- Estrutura para tabela `setup_consumers`
--
...
--
-- Estrutura para tabela `setup_instruments`
--
...
--
-- Estrutura para tabela `setup_objects`
--
...
--
-- Estrutura para tabela `setup_timers`
--
...
--
-- Estrutura para tabela `socket_instances`
--
...
--
-- Estrutura para tabela `socket_summary_by_event_name`
--
...
--
-- Estrutura para tabela `socket_summary_by_instance`
--
...
--
-- Estrutura para tabela `table_io_waits_summary_by_index_usage`
--
...
--
-- Estrutura para tabela `table_io_waits_summary_by_table`
--
...
--
-- Estrutura para tabela `table_lock_waits_summary_by_table`
--
